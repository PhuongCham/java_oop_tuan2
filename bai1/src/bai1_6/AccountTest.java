...
public class AccountTest {
	...
	public void testAccountStringStringInt() {
		Account x=new Account("01","cham",1234);
		assertEquals("01",x.getId());
		assertEquals("cham",x.getName());
		assertEquals(1234,x.getBalance());
	}

	@Test
	public void testGetId() {
		Account x=new Account("01","cham");
		assertEquals("01",x.getId());
	}
	...
	public void testTransferTo() {
		Account x=new Account("01","cham",1234);
		Account y=new Account("02","phuong",100);
		x.transferTo(y, 1300);
		assertEquals(1234,x.getBalance());
		x.transferTo(y,100);
	...
	public void testToString() {
		Account x=new Account("01","cham",1234);
		assertEquals("Account[id=01,name=cham,balance=1234]",x.toString());
	}
