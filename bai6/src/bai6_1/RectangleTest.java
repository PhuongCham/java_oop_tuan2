...
public class RectangleTest {
  ...
  public void testSetWidth() {
    r1.setWidth(1.23);
    assertEquals(1.23, r1.getWidth(), delta);
  }

  @Test
  public void testSetLength() {
    r1.setLength(2.34);
    assertEquals(2.34, r1.getLength(), delta);
  }
  ...
  public void testGetArea() {
    r1.setWidth(3.45);
    r1.setLength(2.34);
    assertEquals(2.34 * 3.45, r1.getArea(), delta);
  }
  ...
  public void testGetPerimeter() {
    r1.setWidth(3.45);
    r1.setLength(2.34);
    assertEquals(2 * (2.34 + 3.45), r1.getPerimeter(), delta);
  }
