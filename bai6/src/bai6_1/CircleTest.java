...
public class CircleTest {
	...
	public void testCircleDoubleStringBoolean() {
		Circle c2 = new Circle(1.5, "blue", false);
	...
	public void testSetRadius() {
		c1.setRadius(1.2);
		assertEquals(1.2,c1.getRadius(),0.001);
	}

	@Test
	public void testGetArea() {
		c1.setRadius(1.2);
		assertEquals(1.2*2.2*Math.PI,c1.getArea(),0.001);
	}

	@Test
	public void testGetPerimeter() {
		c1.setRadius(1.2);
		assertEquals(2*1.2*Math.PI,c1.getPerimeter(),0.001);
	}

	@Test
	public void testToString() {
		Circle c2 = new Circle(1.5, "blue", true);
		String expected = "A Circle with radius=1.5, which is a subclass of A Shape with color of blue and filled";
